...
INSERT INTO konfigurasjon.fieldproperty (id, label, editable, required, checkboxvalidationid, id_field, changed_by, scannable, hide_values, cross_validation) VALUES ('cb9e039e-a1f9-49aa-afe6-aba86fe968d9', '', 1, 1, NULL, 'e4aad805-6426-46fa-841a-3579ad637109', 'PowerCatch Update Script', 1,1,1); -- PC_METER_NUMBER-properties (Ny m�lers m�lernummer)
...
-- FERDIG field on page-- page m�lerdata
